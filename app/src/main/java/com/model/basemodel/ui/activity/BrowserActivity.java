...
import com.model.basemodel.util.webview.SonicJavaScriptInterface;
import com.model.basemodel.util.webview.SonicRuntimeImpl;
import com.model.basemodel.util.webview.SonicSessionClientImpl;
 ...
 * @Description: 描述
 * @Author: WangZhuang
 * @CreateDate: 2019/7/18 0018 上午 11:05
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/7/18 0018 上午 11:05
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class BrowserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.wv_html);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KEYCODE_BACK && webView.canGoBack()) {//浏览的网页回退
            webView.goBack();
            return true;
        }
